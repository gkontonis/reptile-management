...
* `ci` Commits, that affect deployment, ci pipeline, building, infrastructure, backup, recovery
...
* create following file in your repository folder `.git/hooks/pre-receive`
  ...
  commit_msg_type_regex='feat|fix|refactor|style|test|docs|build|ci|chore|revert|perf|docs'
